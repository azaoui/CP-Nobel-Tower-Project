...
public abstract class UICustomProfileSection extends UIForm {
  ...
  public Profile getProfile() throws Exception {
	  UICustomProfile uiProfile = this.getAncestorOfType(UICustomProfile.class);
  ...
  public boolean isEditable() {
	  UICustomProfile pp = this.getAncestorOfType(UICustomProfile.class);
   ...
   *
   */
  public static class EditActionListener extends EventListener<UICustomProfileSection> {
   ...
   *
   */
  public static class SaveActionListener extends EventListener<UICustomProfileSection> {
   ...
   *
   */
  public static class CancelActionListener extends EventListener<UICustomProfileSection> {
