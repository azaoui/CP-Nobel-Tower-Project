...
@ComponentConfig(
  ...
  template = "classpath:groovy/social/webui/profile/CustomUIHeaderSection.gtmpl",
  events = {
    ...
    @EventConfig(listeners = UICustomProfileSection.EditActionListener.class, phase = Phase.DECODE),
    @EventConfig(listeners = UICustomProfileSection.CancelActionListener.class, phase = Phase.DECODE),
    @EventConfig(listeners = UIHeaderSection.SaveActionListener.class)
  }
)
public class UIHeaderSection extends UICustomProfileSection {
