...
@ComponentConfig(
  ...
  template =  "classpath:groovy/social/webui/profile/CustomUIContactSection.gtmpl",
  events = {
...
public class UIContactSection extends UICustomProfileSection {
  /** GENDER */
  ...
  public static class SaveActionListener extends UICustomProfileSection.SaveActionListener {
    ...
    @Override
    public final void execute(final Event<UICustomProfileSection> event) throws Exception {
      super.execute(event);
