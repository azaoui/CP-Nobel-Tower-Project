...
import org.nobeltower.social.webui.profile.UIBasicInfoSection;
import org.nobeltower.social.webui.profile.UIContactSection;
import org.nobeltower.social.webui.profile.UIExperienceSection;
import org.nobeltower.social.webui.profile.UIHeaderSection;
...
@ComponentConfig(
  template = "classpath:groovy/social/webui/profile/UICustomProfile.gtmpl"
)
public class UICustomProfile extends UIContainer {
  ...
  public UICustomProfile() throws Exception {
  ...
  */
  ...
  private List getSections() {
    ...
    sects.add(UIBuildingInfoSection.class);
    return sects;
  }
}
